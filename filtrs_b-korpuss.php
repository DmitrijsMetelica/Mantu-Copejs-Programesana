...
<head>
    ...
    <title>Mantu Copējs: B Korpuss </title>
...
<body id = "enter_background">
    <div id="main_entry_start">
        <div id="top">
            <div class="entry_start_top">
                ...
                <ul>
                    ...
                    <a><li class = "ednica_zemkategorija">B Korpuss</li></a>
        ...
        <div id="content">
            ...
            $sql = "SELECT img, ko_cope, apraksts, statuss, vieta FROM sludinajumi WHERE vieta = '-B Korpuss' ORDER BY id DESC";

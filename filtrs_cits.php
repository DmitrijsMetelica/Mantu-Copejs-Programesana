...
<body id = "enter_background">
    <div id="main_entry_start">
        <div id="top">
            <div class="entry_start_top">
                ...
                <ul>
                    ...
                    <a><li class = "ednica_zemkategorija">Cits</li></a>
        ...
        <div id="content">
            ...
            $sql = "SELECT img, ko_cope, apraksts, statuss, vieta FROM sludinajumi WHERE vieta = '-Cits' ORDER BY id DESC";

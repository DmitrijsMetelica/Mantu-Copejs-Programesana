...
<head>
    ...
    <title>Mantu Copējs: Galvenā ēka</title>
...
<body id = "enter_background">
    <div id="main_entry_start">
        <div id="top">
            <div class="entry_start_top">
                ...
                <ul>
                    ...
                    <a><li class = "ednica_zemkategorija">Galvenā ēka</li></a>
        ...
        <div id="content">
            ...
            $sql = "SELECT img, ko_cope, apraksts, statuss, vieta FROM sludinajumi WHERE vieta = '-Galvenā ēka' ORDER BY id DESC";

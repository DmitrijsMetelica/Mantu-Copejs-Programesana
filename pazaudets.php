...
<head>
    ...
    <title>Mantu Copējs: Pazaudēts</title>
...
<body id = "enter_background">
    <div id="main_entry_start">
        <div id="top">
            <div class="entry_start_top">
                ...
                <ul>
                    ...
                    <a><li class = "pazaudets_zemkategorija">Pazaudēts</li></a>
        ...
        <div id="content">
            ...
            $sql = "SELECT img, ko_cope, apraksts, statuss, vieta FROM sludinajumi WHERE statuss = '-Pazaudēts' ORDER BY id DESC";

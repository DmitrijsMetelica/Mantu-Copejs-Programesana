...
<head>
    ...
    <title>Mantu Copējs: Pēc Alfabēta</title>
...
<body id = "enter_background">
    <div id="main_entry_start">
        <div id="top">
            <div class="entry_start_top">
                ...
                <ul>
                    ...
                    <a><li class = "ednica_zemkategorija">Pēc Alfabēta</li></a>
        ...
        <div id="content">
            ...
            $sql = "SELECT img, ko_cope, apraksts, statuss, vieta FROM sludinajumi ORDER BY ko_cope ASC";
